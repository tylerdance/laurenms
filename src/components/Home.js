    ...
    return (
        <div>
            <div className="home-pics-div">
                <div>
                    <div><Link id="sugiwon" to="/rootrot"><img className="home-pics" src="https://res.cloudinary.com/df3zbbtc1/image/upload/v1633292090/lms%20root%20rot/rootrot11_a1pydc.jpg" alt="" /></Link></div>
                    ...
                    <div><img className="home-pics" src="https://res.cloudinary.com/df3zbbtc1/image/upload/v1633723773/lms%20selfpres/selfpres16_nplkc4.jpg" alt="" /></div>
